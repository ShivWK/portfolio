...
const BackToTopButton = ({ extraMargin = false }) => {
    ...
    return <button onClick={clickHandler} className={`fixed flex w-fit items-center justify-center gap-1 right-6 lg:left-1/2 lg:-translate-x-1/2 bottom-5 bg-[#03336698] border border-blue-400 text-white py-1.5 px-2 rounded-md text-sm cursor-pointer transform transition-all duration-200 ease-linear font-semibold ${showBtn ? "translate-y-o" : "translate-y-[200%]"}`}>
