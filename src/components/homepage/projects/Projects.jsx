...
const Projects = ({ isSmall }) => {
    ...
    return <div ref={containerRef} className={`mx-auto mt-4 lg:w-[1024px] max-lg:px-3 transform ${ready ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"} transition-all duration-400 ease-linear`}>
        ...
        <h3 className="text-2xl text-center lg:text-3xl w-fit font-semibold font-heading tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300 mt-12 lg:mt-14 mb-8 lg:mb-8">Frontend Only Projects</h3>
