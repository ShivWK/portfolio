...
const Contact = memo(() => {
  ...
  return (
    <div className={`text-black w-full flex flex-col justify-center gap-8 mt-2 mb-10 lg:mb-24 transform ${ready ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"} transition-all duration-400 ease-linear`}>
