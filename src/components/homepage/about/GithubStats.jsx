const GithubStats = () => {
    return <div className=" lg:my-1 mx-auto lg:w-[1024px] max-lg:px-3">
        ...
        <div className="backdrop-blur-xl my-6 lg:my-8">
            <img src="https://github-readme-activity-graph.vercel.app/graph?username=ShivWK&theme=github-compact&color=ffffff&border_color=51a2ff&point=51a2ff&radius=16&height=350&from=2024-14-20" />
        </div>
