...
const NavigationMenu = () => {
    ...
    return <nav className="sticky top-5 flex items-center mx-auto text-lg lg:text-xl font-semibold backdrop-blur-md bg-white/5 w-fit rounded-4xl overflow-hidden shadow-[0_0_15px_2px_rgba(3,165,252,0.6)]">
